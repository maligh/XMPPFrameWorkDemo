...
@property (nonatomic, strong) NSDate *bday;//生日
@property (nonatomic, strong) NSData *photo;//照片
@property (nonatomic, strong) NSString *nickname;//昵称
@property (nonatomic, strong) NSString *formattedName;//全名
@property (nonatomic, strong) NSString *familyName;//姓
@property (nonatomic, strong) NSString *givenName;//名
@property (nonatomic, strong) NSString *middleName;//小名
