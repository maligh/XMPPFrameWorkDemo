...
//{
//    return [NSString stringWithFormat:@"%@:%@:%@:%@:%@:%@:%@:%@:%@:%@:%@:%@:%@:%@:%@:%@",self.nickname,self.orgUnits,self.orgName,self.prefix,self.suffix,self.addresses,self.telecomsAddresses,self.emailAddresses,self.jid,self.mailer,self.role,self.logo,self.categories,self.note,self.prodid,self.uid];
//}
